POST = """<새로운 VC 트렌드 시리즈 - 금융기관화 되가는 VC vs 본질을 고수하는 VC> (원문은 댓글 링크)
...
POST_1 = """"Venture Capital Partners Are Leaving Big Firms in Droves" - 대형 VC 파트너들의 이직 러시와 업계 변화
...
POST_2 = """💡돈 되는 AI service 만들기 시리즈 - 오프라인 Agency 싸게 인수 후, AI 활용해 밸류 올려 팔아먹기.
